...
- **仪表盘** — 欢迎卡片 + 统计 + 最近分析 + 热点速览
  <img width="1905" height="896" alt="仪表盘" src="https://github.com/user-attachments/assets/18a5bb4b-9274-4969-b334-a4ab14bb364f" />
- **仓库分析** — 分析报告（评分雷达图 + 模块分析 + 改进建议）
  <img width="1905" height="896" alt="仓库分析" src="https://github.com/user-attachments/assets/ecc0587e-66ff-49e9-a3af-971ef5d66868" />
- **代码问答** — RAG 对话界面（Markdown 渲染 + 代码高亮）
  <img width="1905" height="896" alt="代码问答" src="https://github.com/user-attachments/assets/792da027-1e94-4a69-9893-1bfd403837f2" />
